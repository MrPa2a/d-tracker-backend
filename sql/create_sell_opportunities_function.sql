-- Fonction SQL pour identifier les opportunités de vente (Sell Signal)
-- Retourne les items dont le prix actuel est significativement supérieur à leur moyenne mobile (ajustée par la volatilité)

CREATE OR REPLACE FUNCTION sell_opportunities(
  p_server TEXT,
  p_from DATE,
  p_to DATE,
